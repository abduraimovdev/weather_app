...
final class AppSize {
  ...
  static const SizedBox sizeH20 = SizedBox(height: 20);
  static const SizedBox sizeH10 = SizedBox(height: 10);
  ...
  static const EdgeInsets paddingV8H16 = EdgeInsets.symmetric(vertical: 8, horizontal: 16);
